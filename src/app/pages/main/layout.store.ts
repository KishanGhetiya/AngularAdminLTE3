...
export class LayoutStore {
  ...
  /**
   * [logoSkin description]
   * @method logoSkin
   * @return [description]
   */
  get logoSkin(): Observable<string> {
    return this.layoutState.pipe(pluck('logoSkin'), distinctUntilChanged()) as Observable<string>;
  }
   ...
   * @param value [description]
   */
  public setLogoSkin(value: string): void {
    this.state.next(
      Object.assign(this.state.value, {logSkin: value})
    );
  }
